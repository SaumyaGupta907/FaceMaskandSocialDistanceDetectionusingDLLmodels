...
from modules import detection as config
...
def detect_and_predict_mask(frame, faceNet, maskNet):
	# grab the dimensions of the frame and then con teststruct a blob
	# from it
	(h, w) = frame.shape[:2]
...
maskNet = load_model("output_for_1090/mask_detector.model")
...
while True:
	...
	results = config.detect_people(frame, net, ln,
